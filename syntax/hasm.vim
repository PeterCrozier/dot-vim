...
syn keyword asmKeyword		LOAD SET INC DEC HALT JMP JGT JGE JEQ JNE JLE
syn keyword asmRegister		A D M
...
if version >= 508 || !exists("did_asm_syntax_inits")
  ...
  HiLink asmIdentifier	Statement
  HiLink asmType	Type
